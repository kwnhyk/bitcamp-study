...
import com.eomcs.lms.json.BoardJsonFileDao;
 ...
 // List<Member> memberList = new ArrayList<>();
  ...
  public void contextInitialized(Map<String, Object> context) {
   ...
   // LessonObjectFileDao lessonDao = new LessonObjectFileDao("./lesson.ser2");
    ...
    context.put("lessonDao", new MemberObjectFileDao("./member.ser2"));
    context.put("memberDao", new MemberObjectFileDao("./member.ser2"));
  }
